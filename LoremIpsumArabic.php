...
class LoremIpsumArabic
{
     ...
     */
    public $words = array (
	    'ما', 'لفشل', 'الشطر', 'عرض', 'بل', 'وصل', 'حاول', 'والديون', 'لم', 'كانتا', 'محاولات', 'جهة', 'في', 'بعد', 'أساسي', 'بالفشل', 'أي', 'فعل', 'القادة', 'العالم', 'بحق', 'مع', 'لليابان', 'الأبرياء', 'بعض', 'بـ', 'تشكيل', 'واندونيسيا،', 'كلا', 'هو', 'الجوي', 'السيء', 'معزّزة', 'الخاسرة', 'الأرواح', '٣٠', 'وجزر', 'لإعادة', 'الأوروبيّون', 'ان', 'ومن', 'جنوب', 'وبلجيكا،', 'دول', 'تحت', 'إذ', 'حلّت', 'يعبأ', 'هذا', 'ضمنها', 'أصقاع', 'بقصف', 'قِبل', 'و', 'هذه', 'مسارح', 'ومطالبة', 'بأضرار', 'ثم', 'قبل', 'قد', 'الدول', 'التاريخ،', 'فسقط', 'مساعدة', 'وأكثرها', 'لمّ', 'لان', 'إستيلاء', 'تزامناً', 'وهولندا،', 'لدحر', 'وصافرات', 'الدّفاع', 'جدول', 'مارد', 'به،', 'وإيطالي', 'التخطيط', 'بين', 'أحدث', 'أملاً', 'الربيع،', 'لغات', 'الصفحة', 'من', 'فصل', 'بشرية', 'المسرح', 'كل', 'ذات', 'الصعداء', 'الشتاء،', 'ممثّلة', 'معارضة', 'إيو', 'إختار', 'اعلان', 'الخاطفة', 'عل', 'تلك', 'دنو', 'مايو', 'الجنود', 'اقتصادية', 'تمهيد', 'طوكيو', 'غير', 'ساعة', 'تجهيز', 'اتّجة', 'أن', 'انه', 'أم', 'أراض', 'الرئيسية', 'والفرنسي', 'التغييرات', 'بحث', 'إعلان', 'لمحاكم', 'سبتمبر', 'الدولارات', 'أوزار', 'مقاومة', 'يذكر', 'للجزر', 'وقد', 'مواقعها', 'للصين', 'ليرتفع', 'ولاتّساع', 'اكتوبر', 'الشتوية', 'والروسية', 'أضف', 'تسمّى', 'الأجل', 'الهادي', 'جُل', 'فكانت', 'يبق', 'أعمال', 'أوروبا', 'عدم', 'شرسة', 'على', 'ويتّفق', 'بريطانيا-فرنسا', 'حين', 'الآخر', 'حادثة', 'عن', 'الحرة', 'ترتيب', 'ولم', 'ذلك', 'بداية', 'بخطوط', 'للأراضي', 'نتيجة', 'أخذ', 'المحيط', 'انتباه', 'والكساد', 'كما', 'مرجع', 'الإكتفاء', 'وفي', 'والكوري', 'المتاخمة', 'إعادة', 'فرنسية', 'وصغار', 'مشارف', 'يكن', 'سقوط', 'انتهت', 'انتصارهم', 'تعد', 'بمحاولة', 'عُقر', 'لهيمنة', 'هامش', 'يتم', 'دون', 'الشرقي', 'وتنصيب', 'التبرعات', 'أسر', 'دفّة', 'وجهان', 'ولكسمبورغ', 'المارق', 'تصرّف', 'الكونجرس', 'دارت', 'والنرويج', 'السيطرة', 'العظمى', 'الخطّة', 'كان', 'ليتسنّى', 'الفترة', 'تغييرات', 'العالمية', 'الأوروبي', 'بها', 'عجّل', 'بولندا،', 'أما', 'الثانية', 'نفس', 'شواطيء', 'باستحداث', 'الساحلية', 'الثقيل', 'تم', 'اتفاق', 'كلّ', 'موالية', 'مشاركة', 'بالسيطرة', 'عرفها', 'وانهاء', 'تسبب', 'بهيئة', 'الدمج', 'واشتدّت', 'غريمه', 'ميناء', 'العاصمة', 'إستعمل', 'سكان', 'لها',
    );
